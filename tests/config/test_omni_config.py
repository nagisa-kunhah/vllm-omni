...
def test_mammoth_structured_cache_bundle_routes_only_to_dit_diffusion_config():
    omni_config = _from_pipeline_key(
        "mammoth_moda2",
        cli_overrides={
    ...
    assert dit_stage.diffusion_config.cache_backend == "tea_cache"
    assert dit_stage.diffusion_config.cache_config.rel_l1_thresh == 0.1
...
""",
    ...
    assert omni_config.stage_by_id(1).diffusion_config.cache_config.rel_l1_thresh == 0.12
